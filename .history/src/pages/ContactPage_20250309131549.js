      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ContactPage",
            name: "Contact Gamma Spectre Solutions",
            url: "https://gammaspectre.com.ng/contact",
            email: "info@gammaspectre.com",
          })}
        </script>
      ...
      <div className="contact">
        ...
        <div className="containMain">
          ...
          <div className="contact-info">
            ...
            <p>
              <strong>Address:</strong> 15 Bujumbura St, Wuse 2, Abuja 904101,
              FCT
            </p>
            <p>
